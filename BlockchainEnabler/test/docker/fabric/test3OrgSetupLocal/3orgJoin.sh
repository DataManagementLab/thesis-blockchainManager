...
# Invite the CompanyB to join the network of CompanyA
go run main.go invite -u CompanyA -z ~/.enabler/platform/CompanyC/CompanyC_network1/enabler/CompanyCOrg1_Invite.zip
...
go run main.go accept -u CompanyC -z ~/.enabler/platform/CompanyA/CompanyA_network1/enabler/CompanyAOrg1_accept_transfer.zip
