...
go run main.go add -u kinshuk -z ~/.enabler/platform/ashwin/ashwin_network1/enabler/ashwinOrg1_Invite.zip

go run main.go join -u ashwin -z ~/.enabler/platform/kinshuk/kinshuk_network1/enabler/kinshukOrg1_accept_transfer.zip

go run main.go add -u kinshuk -z ~/.enabler/platform/muhammad/muhammad_network1/enabler/muhammadOrg1_Invite.zip 
...
go run main.go join -u simon -z ~/.enabler/platform/kinshuk/kinshuk_network1/enabler/kinshukOrg1_accept_transfer.zip
